...
class AzureResourceExtractorTest(TestCase):
    ...
    def _test_resource(self, resource):
        ...
        self._test_resource_type(resource['id'], f"{resource['resource_provider']}/{resource['resource_type']}")


    def _create_resource_id(self, subscription_id=None, resource_group=None, resource_provider=None, resource_type=None, resource_name=None):
